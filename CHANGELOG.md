...
- SPF: `SPFError` exceptions carry a `warnings` list of what was noticed before the error; `SPFRecordNotFound` now also has the `data` attribute the other `SPFError` exceptions have
