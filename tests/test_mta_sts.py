...
class TestTxtCnameConflictWiring(unittest.TestCase):
    ...
    TARGET = "_mta-sts.vendor.example"
    LOCAL = "v=STSv1; id=20240101"
    REMOTE = "v=STSv1; id=20240202"
    ...
    def _query(self, target_records):
        ...
        with patch("checkdmarc.mta_sts.query_dns", side_effect=fake):
            return checkdmarc.mta_sts.query_mta_sts_record("example.com")
